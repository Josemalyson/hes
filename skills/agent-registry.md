...
>
> **SOURCE OF TRUTH**: This file defines the SCHEMA for agent registration.
> The INSTANCE is `.hes/agents/registry.json`, generated by `00-bootstrap.md`.
> When the schema changes here, update `00-bootstrap.md` template accordingly.
> Do NOT edit `registry.json` directly — it is generated.
